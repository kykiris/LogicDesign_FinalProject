...
#create_generated_clock -name clk4 -source [get_ports clk] -divide_by 4 [get_pins nolabel_line158/clk4_reg/Q]
#create_generated_clock -name clk_1hz_1 -source [get_ports clk] -divide_by 50000000 [get_pins clock_inst/clk_1hz_1_reg/Q ]
#create_generated_clock -name clk_1hz -source [get_ports clk] -divide_by 50000000 [get_pins mini_game_module/clk_1hz_reg/Q ]

#set_clock_groups -asynchronous -group [get_clocks clk_1hz] -group [get_clocks sys_clk_pin]
#set_clock_groups -asynchronous -group [get_clocks clk_1hz_1] -group [get_clocks sys_clk_pin]
#set_clock_groups -asynchronous -group [get_clocks clk_1hz_1] -group [get_clocks clk4]

create_generated_clock -name clk4 -source [get_ports clk] -divide_by 4 [get_pins nolabel_line160/clk4_reg/Q]
create_generated_clock -name clk_1hz_1 -source [get_ports clk] -divide_by 50000000 [get_pins clock_inst/clk_1hz_1_reg/Q ]
#create_generated_clock -name clk_1hz -source [get_ports clk] -divide_by 50000000 [get_pins mini_game_module/clk_1hz_reg_P/Q ]  ## mini_game_module/clk_1hz_reg_P/Q
...
set_property -dict { PACKAGE_PIN J17   IOSTANDARD LVCMOS33 } [get_ports { anodes[3] }]; #IO_L23P_T3_FOE_B_15 Sch=an[0]
set_property -dict { PACKAGE_PIN J18   IOSTANDARD LVCMOS33 } [get_ports { anodes[2] }]; #IO_L23N_T3_FWE_B_15 Sch=an[1]
set_property -dict { PACKAGE_PIN T9    IOSTANDARD LVCMOS33 } [get_ports { anodes[1] }]; #IO_L24P_T3_A01_D17_14 Sch=an[2]
set_property -dict { PACKAGE_PIN J14   IOSTANDARD LVCMOS33 } [get_ports { anodes[0] }]; #IO_L19P_T3_A22_15 Sch=an[3]
